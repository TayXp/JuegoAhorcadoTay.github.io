function dibujarTablero() {
    ...
    tablero.fillRect(55, 22.5, 1200, 800)
    tablero.beginPath();
    tablero.moveTo(350,500)
    tablero.lineTo(600,500)
    tablero.stroke()
    tablero.closePath()
  }
  ...
  function escrribirLetraCorrecta(index) {
    ...
    let ancho=600/palabraSecreta.length
    tablero.fillText(palabraSecreta[index],355+(ancho*index),620)
    tablero.stroke()
  }
  ...
  function dibujarAhorcado(puntaje) {
    ...
    if(puntaje===7){//linea que sostiene la cuerda 
    ...
    if(puntaje===1){//mano derecha
    tablero.moveTo(850,330)
    tablero.lineTo(800,389)
    }
    if(puntaje===0){//mano izquierda
    tablero.moveTo(850,330)
